...
public class App extends Application {
    ...
    public void start(Stage stage) {
        ...
        Scene scene = new Scene(createLayout(screen, buttons)); // Declare and initialize the scene variable

        // Add this line to set the CSS stylesheet
        scene.getStylesheets().add("styles.css"); // Replace "styles.css" with the actual path to your CSS file
